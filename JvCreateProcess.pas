...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvCreateProcess.pas 137 2009-08-09 19:32:34Z obones $
...
type
  ...
  TJvCreateProcess = class(TComponent)
  private
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvCreateProcess.pas $';
    Revision: '$Revision: 137 $';
    Date: '$Date: 2009-08-09 21:32:34 +0200 (dim., 09 août 2009) $';
    LogPath: 'JVCL\run'
  );
